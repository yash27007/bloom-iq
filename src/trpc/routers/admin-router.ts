...
const courseSortableKeys = ["courseCode", "courseName"] as const;
...
export const adminRouter = createTRPCRouter({
  ...
  getCourses: adminProcedure
    ...
    .query(async ({ input }) => {
      ...
      const orderBy =
        ...
        ({ courseCode: "asc" } as Prisma.CourseOrderByWithRelationInput);
  ...
  updateCourse: adminProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      if (rest.courseCode !== undefined) data.courseCode = rest.courseCode;
      if (rest.courseName !== undefined) data.courseName = rest.courseName;
    ...
    .mutation(async ({ input }) => {
      ...
      for (const c of courses) {
        const total =
          c._count.questions +
          c._count.materials +
          c._count.paperPatterns +
          c._count.generatedPapers;
