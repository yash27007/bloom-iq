...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900/20 relative overflow-hidden transition-colors duration-500">
      {/* Animated background elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-30 dark:opacity-10"></div>
      <div className="absolute top-20 left-10 w-72 h-72 bg-blue-400 dark:bg-blue-600/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl opacity-20 dark:opacity-10 animate-pulse"></div>
      <div className="absolute top-40 right-10 w-72 h-72 bg-purple-400 dark:bg-purple-600/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl opacity-20 dark:opacity-10 animate-pulse delay-1000"></div>
      <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-pink-400 dark:bg-pink-600/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl opacity-20 dark:opacity-10 animate-pulse delay-2000"></div>

      {/* Navigation */}
      <nav className="border-b border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md sticky top-0 z-50 shadow-sm dark:shadow-gray-900/20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16">
        <div className="text-center">
          <Badge className="mb-4 sm:mb-6 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-700 dark:text-blue-300 hover:from-blue-200 hover:to-purple-200 dark:hover:from-blue-800/40 dark:hover:to-purple-800/40 border-0 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium shadow-md dark:shadow-gray-900/30">
            <Zap className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
            College Question Paper Generation System
          </Badge>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 leading-tight px-4 transition-colors duration-300">
            AI-Powered Question Paper
            <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse">
              Generator
            </span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-8 sm:mb-10 max-w-4xl mx-auto leading-relaxed px-4 transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-12 sm:mb-16">
          <Badge className="mb-4 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 text-purple-700 dark:text-purple-300 border-0 px-3 sm:px-4 py-2">
            System Features
          </Badge>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 px-4 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="group border-0 shadow-lg hover:shadow-2xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-all duration-500 hover:-translate-y-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-12 sm:mb-16">
          <Badge className="mb-4 bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900/30 dark:to-blue-900/30 text-green-700 dark:text-green-300 border-0 px-3 sm:px-4 py-2">
            Development Team
          </Badge>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 px-4 transition-colors duration-300">
            Meet Our Development Team
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto px-4 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {teamMembers.map((member, index) => (
            <Card key={index} className="group text-center border-0 shadow-lg hover:shadow-2xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-all duration-500 hover:-translate-y-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden">
              <CardContent className="p-6 sm:p-8">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-2 sm:mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {member.name}
                </h3>
                <a
                  ...
                  className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors font-medium group-hover:underline text-sm sm:text-base"
                >
        ...
        {/* Guidance Section */}
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-100 dark:border-blue-800/30">
            <p className="text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 text-base sm:text-lg font-medium transition-colors duration-300">Project supervised by</p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              <Card className="border-0 shadow-lg hover:shadow-xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-all duration-300 hover:-translate-y-1 bg-white dark:bg-gray-800">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg transition-colors duration-300">Dr. M.K Nagarajan</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-1 transition-colors duration-300">Faculty Supervisor</p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-lg hover:shadow-xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-all duration-300 hover:-translate-y-1 bg-white dark:bg-gray-800">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg transition-colors duration-300">Ms. Reshni</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-1 transition-colors duration-300">Faculty Supervisor</p>
                </CardContent>
              </Card>
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/20 transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4 max-w-md text-sm sm:text-base transition-colors duration-300">
            ...
            {/* Contact */}
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-4 text-sm sm:text-base transition-colors duration-300">Project Information</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-300 text-xs sm:text-sm transition-colors duration-300">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6 sm:pt-8 text-center text-gray-600 dark:text-gray-300 transition-colors duration-300">
            ...
            <p className="text-xs sm:text-sm flex items-center justify-center">
              <CheckCircle2 className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-green-500 dark:text-green-400" />
